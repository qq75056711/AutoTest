...
public class Request {
    ...
    public Header contentType() {
        ...
        header.forEach(header -> {
            if (StringUtils.equalsIgnoreCase(header.getName(), CONTENT_TYPE)){
    ...
    public static class Builder {
        ...
        public Builder headers(Object headers) {
            ...
            if (headers instanceof Header){
                ...
                this.headers.add((Header)headers);
            }
            return this;
        }
        ...
        public Request build() {
            try {
                if (!this.urlCheck()) {
                    throw new Exception("url == null or not a url :  " + url);
                }
        ...
        private boolean urlCheck() {
            return StringUtils.isNotBlank(this.url) && PATTERN.matcher(url).find();
        }
